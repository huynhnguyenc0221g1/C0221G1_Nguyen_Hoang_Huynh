...
<div class="container-fluid col-lg-12 col-sm-2 align-content-center">
...
<div class="row py-4 col-sm-12 col-lg-12">
    <div class="container-fluid justify-content-center">
        <div id="demo" class="carousel slide container-fluid py-4" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../image/main0.jpg"
                         width="100%"/>
                </div>
                <div class="carousel-item">

                    <img src="../../image/main1.jpeg" width="100%"/></div>
                <div class="carousel-item">

                    <img src="../../image/main2.jpeg" width="100%"/></div>
