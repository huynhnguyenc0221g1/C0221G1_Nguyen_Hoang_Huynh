    ...
    <div class="container pt-3">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" required min="0" class="form-control" name="price" value="${product.price}"
                       placeholder="${product.price}">
            </div>
            <div class="form-group">
                <label>Product's Quantity:</label>
                <input type="number" step="1" min="0" class="form-control" name="quantity" value="${product.quantity}"
