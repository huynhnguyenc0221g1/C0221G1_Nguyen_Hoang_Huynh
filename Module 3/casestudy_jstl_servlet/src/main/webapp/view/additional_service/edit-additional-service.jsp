    ...
    <div class="container text-success">
        ...
        <form method="post">
            <div class="form-group">
                <label></label>
                <input hidden type="text" value="${additional_service.id}" name="id" class="form-control"
                       id="formGroupExampleInput"
                       placeholder="Example input placeholder">
            </div>
            <div class="form-group">
                <label>Additional Service's Name</label>
                <input type="text" class="form-control" name="name" value="${additional_service.name}" id="formGroupExampleInput1"
            ...
            <div class="form-group">
                <label >Additional Service's Availability Status</label>
                <input type="text" class="form-control" name="status" value="${additional_service.status}" id="formGroupExampleInput4"
                       placeholder="Another input placeholder">
            </div>
