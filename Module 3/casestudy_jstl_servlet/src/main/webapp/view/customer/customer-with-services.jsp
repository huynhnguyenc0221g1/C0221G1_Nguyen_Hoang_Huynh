...
<div class="row ml-4 mt-4">
    <div class="col-lg-6">
        <h5>Customer With Services</h5>
    </div>
    <div class="col-lg-4 pd-6">
        <form method="get" action="/customer-with-services">
    ...
    <table id="customerTable" class="table table-striped" border="1" cellpadding="5">
        ...
        <c:forEach var="customer" items="${customers}" varStatus="status">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${customer.additionalServiceId == 0}">
                        <td>No Additional Service</td>
                    </c:when>
                    <c:otherwise>
                        <td>${customer.additionalServiceId}</td>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${customer.additionalServiceName == null}">
                        <td>No Additional Service</td>
                    </c:when>
                    <c:otherwise>
